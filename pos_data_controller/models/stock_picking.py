...
class StockPicking(models.Model):
    ...
    def _create_picking_from_pos_order_lines(self, location_dest_id, lines, picking_type, partner=False):
        """Override to use force_picking_location context as source location instead of default."""
        forced_location_id = self.env.context.get('force_picking_location')
        ...
        if positive_lines:
            location_id = forced_location_id or picking_type.default_location_src_id.id
